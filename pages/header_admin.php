...
<div class="container-fluid">
    <header>
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
                <a class="navbar-brand text-primary" href="#">Trang chủ</a>
                ...
                <div>
                    <a href="profile.php" class="text-decoration-none text-success" onclick="">Tài khoản:<strong>NguyetHoang</strong></a>
                    <a href="logout.php" class="btn btn-danger" onclick="">Thoát</a>
                </div>
            </div>
        </nav>
    </header>
